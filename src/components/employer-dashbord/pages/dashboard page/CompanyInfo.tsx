    ...
    >
      ...
      >
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
          ...
          <CardMedia
            sx={{ width: '181px', height: '125px', objectFit: 'cover' }}
            component="img"
      ...
      <Box sx={{ bgcolor: '#fff', paddingBlock: '20px' }}>
        ...
        >
          ...
          <Typography
            ...
            sx={{ fontFamily: 'shabnam', fontSize: '12px' }}
          >
            زمینه فعالیت توضیحات بیشتر مجموعه بین المللی کیکاووس زمان در دو حوزه
            تامین منابع انسانی و آموزش فعال می باشد. همکاری با شرکتهای نفت و گاز
            پتروشیمی، نیرو و ... از سوابق این شرکت می باشد.
          </Typography>
        </Box>
      </Box>
    </Box>
